...
The GB1 dataset was **not** generated by us. If you use this dataset, please cite the original paper:
...
- Added the GB1 case study and the ECFP calculations.  
- Due to storage constraints, the `Data/` folder has been moved to Zenodo.
